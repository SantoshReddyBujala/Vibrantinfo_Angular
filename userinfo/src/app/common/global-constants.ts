export class GlobalConstants {
    ...
    static readonly unameMinLbl: string = "User name minimum of 8 characters length";
    ...
    static readonly lnameLbl: string = "Last name";
    static readonly lnameReqLbl: string = "Please enter Last name";
    ...
    static readonly addrLbl: string = "Address";
    static readonly addrReqLbl: string = "Please enter Address";
